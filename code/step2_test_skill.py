...
def ansSkill(index, output, fsm, rounds, request, lastQuestion, Inpt, time_before_testing, all_rounds):
    questions = []
    for req in request:
        if req[1] != 'Alexa':
    ...
    elif all_rounds >= 20 - 1: #time.time() - time_before_testing >= Constant.TIME_LIMIT:
